...
(function() {
    ...
    const styles = `
        .n8n-chat-widget {
            --chat--color-primary: var(--n8n-chat-primary-color, #05668d);
            --chat--color-secondary: var(--n8n-chat-secondary-color, #ff956b);
            --chat--color-background: var(--n8n-chat-background-color, #f4f2f1);
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="Escreva a mensagem aqui..." rows="1"></textarea>
